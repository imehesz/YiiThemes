...
<head>
  ...
  <title>Laravel Theme Factory - <?php echo $this->pageTitle; ?></title>
...
<body>
  <div class="navbar navbar-laravel navbar-fixed-top">
  ...
  <div class="container">
    ...
    <footer id="footer">
      <p>
        <div class="label pull-right">v 3.0.<span id='VERSION_ID'>2016.1126.2125</span></div>
      </p>
      <div class="links">
